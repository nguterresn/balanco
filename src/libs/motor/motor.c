...
static const struct pwm_dt_spec gpio0 =
    PWM_DT_SPEC_GET(DT_NODELABEL(pwm_ch0_gpio0));
static const struct pwm_dt_spec gpio1 =
    PWM_DT_SPEC_GET(DT_NODELABEL(pwm_ch1_gpio1));
static const struct pwm_dt_spec gpio2 =
    PWM_DT_SPEC_GET(DT_NODELABEL(pwm_ch2_gpio2));
static const struct pwm_dt_spec gpio3 =
    PWM_DT_SPEC_GET(DT_NODELABEL(pwm_ch3_gpio3));
